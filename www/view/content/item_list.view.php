...
<?php } else { ?>
        <div id="item_list"><script> Izheko.item_count = <?= $item_count = count($data['items']) ?>; Izheko.item_list_init(); </script><!--
<?php foreach($data['items'] as $i => $item) { ?>
         --><div class="item-wrapper"><div class="item">
                <a class="pic" id="pic<?= ++$i ?>" data-itemid="<?= $item->get('num_iid') ?>" target="_blank" href="#"></a>
                <?php if ($i === 10 || $i === $item_count) { ?> <script> Izheko.lazy_img(); </script> <?php } ?>
